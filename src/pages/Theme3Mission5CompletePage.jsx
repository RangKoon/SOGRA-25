...
function Theme3Mission5CompletePage() {
  const navigate = useNavigate();

  const handleNext = () => {
    navigate('/theme3/ep6/qr-scan');
  };
    ...
    <div className="mission-complete-container">
      ...
      <div className="mission-complete-wrapper">
        <div className="mission-image-section">
          <img
            src="/src/images/theme3_mission5_complete.png"
            alt="미션 5 완료"
...
export default Theme3Mission5CompletePage;
