...
function Theme3Mission3CompletePage() {
  const navigate = useNavigate();

  const handleNext = () => {
    navigate('/theme3/ep4/qr-scan');
  };
    ...
    <div className="mission-complete-container">
      ...
      <div className="mission-complete-wrapper">
        <div className="mission-image-section">
          <img
            src="/src/images/theme3_mission3_complete.png"
            alt="미션 3 완료"
...
export default Theme3Mission3CompletePage;
