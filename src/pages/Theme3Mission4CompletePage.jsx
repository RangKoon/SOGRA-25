...
function Theme3Mission4CompletePage() {
  const navigate = useNavigate();

  const handleNext = () => {
    navigate('/theme3/ep5/qr-scan');
  };
    ...
    <div className="mission-complete-container">
      ...
      <div className="mission-complete-wrapper">
        <div className="mission-image-section">
          <img
            src="/src/images/theme3_mission4_complete.png"
            alt="미션 4 완료"
...
export default Theme3Mission4CompletePage;
